...
export interface CertificateNFTInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getBaseTokenURI",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface CertificateNFT extends BaseContract {
  ...
  certificates: TypedContractMethod<
    [arg0: BigNumberish],
    [
      [string, string, string, string, string, bigint, string, boolean] & {
        studentName: string;
        courseName: string;
        grade: string;
        ipfsHash: string;
  ...
  getBaseTokenURI: TypedContractMethod<[], [string], "view">;
  ...
  updateCertificate: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "getBaseTokenURI"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "updateCertificate"
  ): TypedContractMethod<
    [tokenId: BigNumberish, studentName: string, department: string],
    [void],
    "nonpayable"
  ...
  filters: {
    ...
    "SemesterCertificateIssued(uint256,address,string,string,string,uint256,uint256)": TypedContractEvent<
      SemesterCertificateIssuedEvent.InputTuple,
      SemesterCertificateIssuedEvent.OutputTuple,
      SemesterCertificateIssuedEvent.OutputObject
    >;
